<template>
    <Modal class="night-reference"
           @close="toggleModal('nightOrder')"
           v-if="modals.nightOrder && roles.size">
        <font-awesome-icon @click="toggleModal('reference')"
                           icon="address-card"
                           class="toggle"
            ...
            <ul>
                <li class="tabs" :class="tab">
                    <span class="tab"
                          ...
                          :class="{ active: tab == 'first_night' }">First Night</span>
                    <span class="tab"
                          icon="broadcast-tower"
                          @click="tab = 'otherNight'"
                          :class="{ active: tab == 'otherNight' }">Other Nights</span>
                      ...
                      '.png')
                            ...
                            <span class="role">
                                ...
                                <span class="player" v-if="role.players.length">
                                    <br />
                                    <small class="reference" v-for="(player, index) in role.players"
